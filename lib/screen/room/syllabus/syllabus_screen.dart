...
import 'package:stady_square/screen/room/syllabus/files_screen.dart';
...
class SyllabusScreen extends StatefulWidget {
  ...
  final String name;
  const SyllabusScreen({Key? key,required this.roomModel, required this.name}) : super(key: key);
...
class _SyllabusScreenState extends State<SyllabusScreen> {
  ...
  @override
  void initState() {
    BlocProvider.of<AppCubit>(context).getSyllabus(roomID: widget.roomModel.roomId??'');
    super.initState();
  }
        ...
        builder: (context,state){
          ...
          return Scaffold(
                ...
                (widget.roomModel.ownerUserId == cubit.profileModel?.id) ?IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context){
                      return AddSyllabus(roomId: widget.roomModel.roomId??'',);
                    }));
                  },
                ):Container()
              ],
            ...
            ListView.builder(
                ...
                itemCount: cubit.syllabusList.length,
                itemBuilder: (context,index){
                  return ListTile(
                    title: Text(cubit.syllabusList[index].syllabusName??'',
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context){
                        return FilesScreen( list: cubit.syllabusList[index].filesList??[],roomModel: widget.roomModel,
                          id: cubit.syllabusList[index].syllabusId.toString(),);
                      }));
                    },
                  );
                }),
...
class AddSyllabus extends StatelessWidget {
  final String roomId;
  AddSyllabus({Key? key, required this.roomId}) : super(key: key);
